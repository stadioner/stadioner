...
const contentByLanguage: Record<SupportedLanguage, SalandaSectionContent> = {
  cs: {
    ...
    openingHours: [
      ...
      { key: 'sat', label: 'Sobota', value: '11:00 - 22:00', closed: false },
  ...
  en: {
    ...
    openingHours: [
      ...
      { key: 'sat', label: 'Saturday', value: '11:00 - 22:00', closed: false },
  ...
  de: {
    ...
    openingHours: [
      ...
      { key: 'sat', label: 'Samstag', value: '11:00 - 22:00', closed: false },
