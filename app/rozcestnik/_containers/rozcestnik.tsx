...
export const Rozcestnik = () => {
  ...
  const links: Record<string, LinkItem[]> = {
    cs: [
      ...
      {
        title: 'E-shop',
        description: 'Online objednávání našich produktů',
        href: '#',
      ...
      {
        title: 'QR kód',
        description: 'Rychlý přístup k informacím o pivovaru',
        href: '/qr',
        icon: <Globe size={24} />,
        category: 'info',
      },
    ...
    en: [
      ...
      {
        title: 'E-shop',
        description: 'Online ordering of our products',
        href: '#',
        icon: <ShoppingCart size={24} />,
        external: true,
        category: 'products',
      ...
      {
        title: 'QR Code',
        description: 'Quick access to brewery information',
        href: '/en/qr',
        icon: <Globe size={24} />,
        category: 'info',
      },
    ...
    de: [
      ...
      {
        title: 'E-Shop',
        description: 'Online-Bestellung unserer Produkte',
        href: '#',
        icon: <ShoppingCart size={24} />,
        external: true,
        category: 'products',
      ...
      {
        title: 'QR-Code',
        description: 'Schneller Zugang zu Brauereiinformationen',
        href: '/de/qr',
        icon: <Globe size={24} />,
        category: 'info',
      },
