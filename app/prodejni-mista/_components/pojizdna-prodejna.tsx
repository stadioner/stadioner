...
export const PojizdnaProdejna = () => {
  ...
  return (
    <section className='bg-brand-primary py-12'>
      <Container>
        <div className='pb-6'>
          <h2 className='text-brand-action flex-nowrap text-3xl font-bold text-nowrap md:text-4xl lg:text-6xl'>
          ...
          <div className='order-1 md:order-2'>
            <div className='mb-4 flex items-center gap-3'>
              <button
                ...
                onClick={goPrev}
                className='border-brand-action text-brand-action hover:bg-brand-action hover:text-brand-primary cursor-pointer rounded-md border p-2 transition-colors'
              >
            ...
            <h3 className='text-brand-action text-2xl font-bold md:text-4xl'>
              {current.place}
            </h3>
            ...
            <a
              ...
              className='text-brand-action mt-4 inline-flex items-center gap-2'
            >
              <PhoneIcon size={16} />
              {current.contact}
            </a>
