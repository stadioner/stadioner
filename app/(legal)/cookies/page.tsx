    ...
    <main className='bg-brand-primary pt-32 pb-20 md:pt-40'>
      <Container className='max-w-4xl'>
        <div className='prose prose-lg max-w-none'>
          ...
          <p className='mb-8 text-gray-600'>{t.lastUpdated}</p>
          ...
          <div className='space-y-8'>
            ...
            <section>
              ...
              <p className='mb-4 text-gray-700'>{t.howWeUse.content}</p>
            ...
            <section>
              ...
              <div className='space-y-6'>
                <div>
                  <h3 className='text-brand-action mb-2 text-xl font-semibold'>
            ...
            <section>
              ...
              <p className='mb-4 text-gray-700'>{t.thirdParty.content}</p>
              <ul className='list-inside list-disc space-y-2 text-gray-700'>
            ...
            <section>
              ...
              <p className='mb-4 text-gray-700'>{t.managingCookies.content}</p>
            ...
            <section>
              ...
              <p className='mb-4 text-gray-700'>{t.consent.content}</p>
            ...
            {hasConsented && (
              <section className='border-t border-gray-300 pt-8'>
                ...
                <div className='bg-brand-secondary mb-6 p-4'>
                  <h3 className='text-brand-action mb-3 font-semibold'>
                  ...
                  <div className='grid gap-2 text-sm'>
                    <div className='flex justify-between'>
                      ...
                      <span
                        className={
                          cookiePreferences.essential ? 'text-green-600' : (
                            'text-red-600'
                          )
                        }
                      >
                    ...
                    <div className='flex justify-between'>
                      ...
                      <span
                        className={
                          cookiePreferences.functional ? 'text-green-600' : (
                            'text-red-600'
                          )
                        }
                      >
                    ...
                    <div className='flex justify-between'>
                      ...
                      <span
                        className={
                          cookiePreferences.analytics ? 'text-green-600' : (
                            'text-red-600'
                          )
                        }
                      >
                    ...
                    <div className='flex justify-between'>
                      ...
                      <span
                        className={
                          cookiePreferences.marketing ? 'text-green-600' : (
                            'text-red-600'
                          )
                        }
                      >
                ...
                {showPreferences && (
                  <div className='bg-brand-secondary p-6'>
                    <h3 className='text-brand-action mb-4 text-lg font-semibold'>
                      {t.preferences.manageButton}
                    </h3>
                    ...
                    {/* Save Button */}
                    <div className='border-brand-action mt-6 flex justify-end border-t pt-4'>
                      <Button
