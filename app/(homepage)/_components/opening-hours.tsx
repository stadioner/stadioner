...
export const OpeningHours = () => {
  ...
  return (
    <section className='bg-brand-action text-brand-primary relative py-16'>
      <div
      ...
      <Container>
        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center'>
          ...
          <div className='flex flex-col space-y-8'>
            ...
            <div className='divide-brand-primary/80 w-full divide-solid text-lg md:text-xl'>
              {rows.map((row) => (
                <div
                  key={row.key}
                  className={cn(
                    'my-3 flex items-center justify-between px-3 py-3 transition-colors',
                    row.isToday &&
            ...
            <div className='pt-8'>
              ...
              <address className='text-lg not-italic md:text-xl'>
                <p>{t.address_line1}</p>
                <p>{t.address_line2}</p>
              </address>
            </div>
